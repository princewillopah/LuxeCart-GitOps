...
VALUES ('admin@luxecart.com', 'NEEDS_BCRYPT_HASH', 'Admin', 'User', 'admin')
ON CONFLICT (email) DO NOTHING;

-- Insert seed regular users (password: 123456 for all)
INSERT INTO users (email, password, first_name, last_name, role) VALUES
('john@luxecart.com', 'NEEDS_BCRYPT_HASH', 'John', 'Doe', 'user'),
('jane@luxecart.com', 'NEEDS_BCRYPT_HASH', 'Jane', 'Smith', 'user'),
('bob@luxecart.com', 'NEEDS_BCRYPT_HASH', 'Bob', 'Johnson', 'user'),
('alice@luxecart.com', 'NEEDS_BCRYPT_HASH', 'Alice', 'Williams', 'user')
ON CONFLICT (email) DO NOTHING;
